...
test("the build side resolves the workspace's shipped app-env", () => {
  // With no process override, buildAuthEnabled reflects the workspace file
  // (currently "true" since 2368359); an explicit override always wins.
  const fileFlag = buildAuthEnabled(projectRoot(), {});
  assert.equal(typeof fileFlag, "boolean");
