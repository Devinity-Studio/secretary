...
// Sandbox writes under /workspace; on a real checkout the project root is the
// workspace — both are allowed, and paths outside either still fail closed.
const projectRoot = dirname(fileURLToPath(import.meta.url)).replace(/\\scripts$/, "");
const allowedRoots = ["/workspace", projectRoot];
